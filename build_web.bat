...
set files=%OUT_DIR%\game.wasm %ODIN_PATH%\vendor\raylib\wasm\libraylib.a %ODIN_PATH%\vendor\raylib\wasm\libraygui.a source\box2d\lib\box2d_wasm.o source\clay-odin\wasm\clay.o
